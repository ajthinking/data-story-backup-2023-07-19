    ...
    <div className="flex flex-col space-y-2">
      ...
      <div className="flex w-full space-x-2 align-end">
        {/* <button
          ...
          className="flex items-center justify-center space-y-4 space-x-2 my-4 font-mono text-xs w-full uppercase px-8 py-1 rounded text-blue-500 border border-blue-500"
          onClick={() => {
            onRun()
            setShowModal(false)
          }}
